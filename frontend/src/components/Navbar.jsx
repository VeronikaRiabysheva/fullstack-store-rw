			...
			<div className='container mx-auto px-4 py-3'>
				<div className='flex flex-wrap justify-between items-center'>
					 ...
					 ease-in-out'
						...
						onClick={logout}
							...
							<>
								<Link
									to={"/signup"}
									className='bg-sky-600 hover:bg-sky-700 text-white py-2 px-2 text-sm sm:text-base md:text-lg 
                  py-1 sm:py-2 px-2 sm:px-4
								...
								<Link
									to={"/login"}
									className='bg-zinc-700 hover:bg-zinc-600 text-white py-2 px-2 text-sm sm:text-base md:text-lg 
                  py-1 sm:py-2 px-2 sm:px-4
									rounded-md flex items-center transition duration-300 ease-in-out'
								>
